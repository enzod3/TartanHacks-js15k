...
export const SONG: any[] = [
    // Instruments
    [
        [1.5, 0, 65, , .5, .3, 2, 2.5, , , , , , .2, , , .04, .6],    // 0: Dark bass
        [.6, 0, 200, , .15, .25, 0, 1, , , , , , , , , , .4],          // 1: Eerie pad
        [.3, 0, 300, .01, .05, .1, 2, 1.5, , , , , , .5, , , , .3],    // 2: Percussive hit
    ],
    // Patterns
    [
        ...
        // Pattern 2: Bass + pad + perc
        [
            [0, 0, 13, 0, 0, 0, 8, 0, 0, 0, 9, 0, 0, 0, 11, 0, 0, 0],
            [1, 0, 25, 0, 0, 28, 0, 0, 20, 0, 0, 0, 18, 0, 0, 0, 0, 0],
            [2, 0, 25, 0, 0, 25, 0, 0, 25, 0, 0, 25, 0, 0, 25, 0, 0, 25],
        ],
    ],
    // Sequence
    [0, 0, 1, 1, 2, 2, 1, 2],
